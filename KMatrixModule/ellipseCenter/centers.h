...
template <typename T>
void jacobian_alternative(libNumerics::matrix<T>& J, const libNumerics::vector<T>& P, int wi, int he, bool clr, int xbegin, int xend, int ybegin, int yend)
{
	T l1=P[0], l2=P[1], theta=P[2], tu=P[3], tv=P[4], r1=P[5], p=P[6], r2=P[7], vh=P[8], vb=P[9], c=P[10];
	int idx = 0;
...
template <typename T>
void jacobian(libNumerics::matrix<T>& J, const libNumerics::vector<T>& P, int wi, int he, bool clr, int xbegin, int xend, int ybegin, int yend)
{
	T l1=P[0], l2=P[1], theta=P[2], tu=P[3], tv=P[4], r1=P[5], p=P[6], r2=P[7], vh=P[8], vb=P[9], c=P[10];
	int idx = 0;
	for (int v = ybegin; v <= yend; v++) {
